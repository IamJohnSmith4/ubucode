...
class OdomRobot:
    ...
    (2, 8): [("rotate", 180), ("move", 1.0), ("rotate", 90),("move", 10.0, l),("move", 11.6, l),("rotate", -90),("move", 4.4),("move", 4.2),("rotate", -90),("move", 4.0, l),("move", 4.0),("rotate", 90),("move", 1.0)],
    (2, 9): [("rotate", 180), ("move", 1.0), ("rotate", 90),("move", 10.0, l),("move", 11.6, l),("rotate", -90),("move", 4.4),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("rotate", 90),("move", 1.0)],
    (2, 10):[("rotate", 180), ("move", 1.0), ("rotate", 90),("move", 10.0, l),("move", 11.6, l),("rotate", -90),("move", 4.4),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 4.0, l),("move", 4.0),("rotate", 90),("move", 1.0)],
    ...
    (3, 8): [("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, l),("move", 4.3, l),("rotate", -90),("move", 5.2),("move", 4.2),("rotate", -90),("move", 4.0, l),("move", 4.0),("rotate", 90),("move", 1.0)],
    (3, 9): [("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, l),("move", 4.3, l),("rotate", -90),("move", 5.2),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0),("rotate", 90),("move", 1.0)],
    (3, 10):[("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, l),("move", 4.3, l),("rotate", -90),("move", 5.2),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0),("rotate", 90),("move", 1.0)],
    (3, 11):[("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, l),("move", 4.3, l),("rotate", -90),("move", 5.2),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, l),("move", 8.0),("rotate", 90),("move", 1.0)],
    ...
    (5, 2): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0),("rotate", -90),("move", 4.0),("rotate", 90),("move", 7.0, r),("move", 7.0, r),("move", 7.0),("rotate", -90),("move", 1.0)],
    ...
    (8, 1): [("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0, r), ("move", 5.0), ("move", 5.0, r), ("move", 5.0, r), ("move", 5.0), ("move", 4.0, r),("rotate", 90),("move", 5.0, r), ("move", 5.0), ("move", 5.0),("rotate", 90)],
    ...
    (8, 6): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, -0.02),("rotate", 90),("move", 4.0),("rotate", -90),("move", 7.0, -0.01),("move", 7.0),("move", 7.0, -0.01),("rotate", 90),("move", 1.0)],
    ...
    (8, 10):[("rotate", 180),("move", 1.0),("rotate", 90),("move", 6.0),("move", 6.0),("move", 5.0, r),("rotate", 90),("move", 1.0)],
    (8, 11):[("rotate", 180),("move", 1.0),("rotate", 90),("move", 5.0),("move", 5.0),("move", 5.0),("move", 5.0, r),("move", 4.0),("rotate", 90),("move", 1.0)],
    ...
    (9, 11):[("rotate", 180),("move", 1.0),("rotate", 90),("move", 5.0),("move", 5.0),("move", 5.0, r),("move", 1.0),("rotate", 90),("move", 1.0)],
    
    (10, 1):[("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0), ("move", 5.0),("rotate", 90),("move", 5.0, r), ("move", 5.0), ("move", 5.0, r),("rotate", 90)],
    ...
    (10, 11):[("rotate", 180),("move", 1.0),("rotate", 90),("move", 5.0),("move", 3.0, r),("rotate", 90),("move", 1.0)],
    
    (11, 1):[("rotate", 180), ("move", 1.0), ("rotate", 90),("move", 5.0, r),("rotate", -90),("move", 5.0),("move", 5.0),("move", 5.0),("rotatr", 90)],
    (11, 2):[("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, r),("rotate", -90),("move", 5.0),("move", 4.2),("rotate", -90),("move", 5.0, l),("move", 5.0, l),("move", 5.2,l),("rotate", 90),("move", 1.0)],
    (11, 3):[("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0, r),("rotate", -90),("move", 4.4),("move", 4.4),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move",8.0, l),("move", 3.2, l),("rotate", 90),("move", 1.0)],
    (11, 4):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, 0.02),("move", 8.0),("rotate", 90),("move", 4.0),("rotate", -90),("move", 5.6),("rotate", -90),("move", 1.0)],
    ...
    (11, 8):[("rotate", 180),("move", 1.0),("rotate", -90),("move", 5.0),("move", 5.0),("move", 5.0),("move", 5.0, r),("move", 4.0),("rotate", -90),("move", 1.0)],
