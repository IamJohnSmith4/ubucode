...
class OdomRobot:
    ...
    (1, 5): [("rotate", -90), ("move", 6.5, 0.01),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 10.0, l),("move", 10.0, l),("rotate", -90),("move", 4.0),("rotate", 90),("move", 6.0, l),("move", 6.0, l),("move", 4.0, l),("rotate", 90),("move", 1.0)],
    (1, 6): [("rotate", -90), ("move", 6.5, 0.01),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 10.0, l),("move", 10.0, l),("rotate", -90),("move", 4.0),("rotate", 90),("move", 6.0),("move", 6.0),("move", 4.0),("rotate", 90),("move", 1.0)],
    ...
    (1, 8): [("rotate", -90), ("move", 5.0, r),("move", 5.0, r),("move", 5.0, r),("rotate", 90),("move", 5.0, r),("move", 5.0, r),("move", 5.0, r),("move", 5.0, r),("move", 5.0, r),("move", 4.0, r),("rotate", -90),("move", 1.0)],	
    ...
    (2, 11):[("rotate", 180), ("move", 1.0), ("rotate", 90),("move", 10.0, 0.02),("move", 11.6,0.02),("rotate", -90),("move", 4.4),("move", 4.2),("rotate", -90),("move", 8.0, l),("move", 8.0),("move", 8.0, l),("move", 8.0, l),("rotate", 90),("move", 1.0)],
