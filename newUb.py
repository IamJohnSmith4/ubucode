...
class OdomRobot:
    ...
    (1, 4): [("rotate", -90), ("move", 6.5),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 5.0, 0.01),("move", 5.0),("move", 5.0),("move", 2.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("rotate", 90),("move", 5.6, 0.01),("rotate", 90),("move", 1.0)],
    (1, 5): [("rotate", -90), ("move", 6.5),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 5.0, 0.01),("move", 5.0),("move", 5.0),("move", 2.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("rotate", 90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (1, 6): [("rotate", -90), ("move", 6.5),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 5.0, 0.01),("move", 5.0),("move", 5.0),("move", 2.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("rotate", 90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],
    (1, 7): [("rotate", -90), ("move", 6.5),("rotate", 90),("move", 10.0, l),("move", 10.0, l),("move", 5.0, 0.01),("move", 5.0),("move", 5.0),("move", 2.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("rotate", 90),("move", 5.6, 0.01),("rotate", -90),("move", 1.0)],
    (1, 8): [("rotate", -90), ("move", 5.0, 0.01),("move", 5.0),("move", 5.0, 0.01),("rotate", 90),("move", 5.0, l),("move", 5.0,  l),("move", 5.0, l),("move", 5.0, 0.01),("move", 5.0),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],	
    (1, 9): [("rotate", -90), ("move", 5.0, 0.01),("move", 5.0),("move", 5.0, 0.01),("rotate", 90),("move", 5.0, l),("move", 5.0, 0.01),("move", 5.0, 0.01),("rotate", -90),("move", 1.0)],
    (1, 10):[("rotate", -90), ("move", 5.0, 0.01),("move", 5.0),("move", 5.0, 0.01),("rotate", 90),("move", 5.0, 0.01),("move", 5.0, 0.01),("rotate", -90),("move", 1.0)],
    (1, 11):[("rotate", -90), ("move", 5.0, 0.01),("move", 5.0),("move", 5.0, 0.01),("rotate", 90),("move", 5.0, 0.01),("rotate", -90),("move", 1.0)],
    ...
    (2, 8): [("rotate", 180), ("move", 1.0),("rotate", 90),("move", 7.0, l),("move", 7.0, 0.01),("move", 7.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (2, 9): [("rotate", 180), ("move", 1.0),("rotate", 90),("move", 7.0, l),("move", 7.0, 0.01),("move", 7.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("rotate", 90),("move", 1.0)],
    (2, 10):[("rotate", 180), ("move", 1.0),("rotate", 90),("move", 7.0, l),("move", 7.0, 0.01),("move", 7.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 4.0),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (2, 11):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 5.0, l),("move", 5.0, 0.01),("move", 5.2, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 5.0, 0.01),("rotate", 90),("move", 1.0)],
    ...
    (3, 8): [("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0, l),("move", 4.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (3, 9): [("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0, l),("move", 4.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 8.0, l),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (3, 10):[("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0, l),("move", 4.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 4.0),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (3, 11):[("rotate", 180), ("move", 1.0),("rotate", 90),("move", 5.0, l),("move", 4.0, 0.01),("rotate", -90),("move", 5.2, 0.01),("move", 4.2, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("move", 4.0),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    ...
    (4, 8): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 5.6, l),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (4, 9): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 5.6, l),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 8.0, l),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (4, 10):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 5.6, l),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 4.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (4, 11):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 5.6, l),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("move", 4.0),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    ...
    (8, 4): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 4.0, l),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", 90),("move", 1.0)],
    (8, 5): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 4.0, l),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (8, 6): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 4.0, l),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],
    ...
    (9, 4): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 6.0, l),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", 90),("move", 1.0)],
    (9, 5): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 6.0, l),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (9, 6): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 6.0, l),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],
    (9, 7): [("rotate", 180), ("move", 1.0),("rotate", -90),("move", 6.0, l),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", -90),("move", 1.0)],
    ...
    (10, 4):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", 90),("move", 1.0)],
    (10, 5):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (10, 6):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],
    (10, 7):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("move", 8.0),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", -90),("move", 1.0)],
    ...
    (11, 4):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", 90),("move", 1.0)],
    (11, 5):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", 90),("move", 1.0)],
    (11, 6):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 6.0, 0.01),("move", 6.0, 0.01),("move", 4.0, 0.01),("rotate", -90),("move", 1.0)],
    (11, 7):[("rotate", 180), ("move", 1.0),("rotate", -90),("move", 8.0, l),("move", 8.0, l),("move", 8.0, 0.01),("move", 8.0, 0.01),("rotate", 90),("move", 4.0, 0.01),("rotate", -90),("move", 5.6, 0.01),("rotate", -90),("move", 1.0)],
