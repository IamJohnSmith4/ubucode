...
class OdomRobot:
    ...
    (2, 3): [("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0),("move", 3.0),("rotate", 90),("move", 1.0)],
    ...
    (2, 8): [("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 10.0),("move", 11.6),("rotate", -90),("move", 4.2),("move", 4.2),("rotate", -90),("move", 8.0),("move", 8.0),("move", 5.6),("rotate", 90),("move", 1.0)],
    ...
    (3, 2): [("rotate", 180), ("move", 1.0), ("rotate", -90), ("move", 5.0),("move", 3.0),("rotate", -90),("move", 1.0)],
    ...
    (3, 8): [("rotate", 180), ("move", 1.0), ("rotate", 90), ("move", 5.0),("move", 2.2),("rotate", -90),("move", 4.2),("move", 4.2),("rotate", 90),("move", 8.0),("move", 8.0),("move", 5.6),("rotate", -90),("move", 1.0)],
